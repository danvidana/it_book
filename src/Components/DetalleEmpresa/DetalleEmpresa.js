				...
				<Row>
					<Col className='col-md-8 col-sm-12'>
						<Row className='text-left row_contacto'>
							<Col className='row_descripcion '>E-mail:</Col>
							<Col>{props.datosEmpresa.email}</Col>
						</Row>
						<Row className='text-left row_contacto'>
							<Col className='row_descripcion'>Teléfono:</Col>
							<Col>{props.datosEmpresa.telefono}</Col>
						</Row>
						<Row className='text-left row_contacto'>
							<Col className='row_descripcion'>Dirección:</Col>
							<Col>
